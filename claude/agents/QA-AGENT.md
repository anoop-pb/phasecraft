...
- Read: `/prd/`, `/app/tests/`, `/app/` (implementation context only), `PHASES.md`, `TRACKER.md`, `.claude/agents/AGENT-STANDARDS.md`, `/.agentic-reviews/qa/` (test results and prior run reports)
